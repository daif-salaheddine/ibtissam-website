...
const AWARDS = [
  { name: 'FWA',             nameClass: 'font-bold text-sm sm:text-base tracking-tight', count: 'x1'  },
  { name: 'W.',              nameClass: 'font-bold text-lg sm:text-xl',                  count: 'x7'  },
  { name: 'CSSDesignAwards', nameClass: 'font-bold text-[10px] sm:text-xs tracking-tight', count: 'x22' },
]
...
export default function App() {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-end">
            ...
            <div className="flex flex-col gap-4 sm:gap-6 justify-end">
              ...
              <div className="self-start">
                <button className="flex items-center gap-3 border border-white/30 px-6 py-3 backdrop-blur-sm bg-white/5 hover:bg-white/10 transition-colors">
      ...
      <div
        className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex flex-col transition-all duration-500"
        style={{
